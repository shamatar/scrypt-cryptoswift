...
class scryptTests: XCTestCase {
    ...
    func testNativeSalsa208DoubleRound() {
        var input: [UInt32] = [0x00000001, 0x00000000, 0x00000000, 0x00000000,
                               0x00000000, 0x00000000, 0x00000000, 0x00000000,
                               0x00000000, 0x00000000, 0x00000000, 0x00000000,
                               0x00000000, 0x00000000, 0x00000000, 0x00000000]
    ...
    func testBufferStorageSalsa208DoubleRound() {
        let input: [UInt32] = [0x00000001, 0x00000000, 0x00000000, 0x00000000,
                               0x00000000, 0x00000000, 0x00000000, 0x00000000,
                               0x00000000, 0x00000000, 0x00000000, 0x00000000,
                               0x00000000, 0x00000000, 0x00000000, 0x00000000]
        let storage = BufferStorage<UInt32>(array: input)
        measure {
            Salsa.doubleround(storage)
        }
    }
